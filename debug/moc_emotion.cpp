...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Emotion_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Emotion_t qt_meta_stringdata_Emotion = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Emotion"
QT_MOC_LITERAL(1, 8, 6), // "imgurl"
...
void Emotion::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->imgurl((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Emotion::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Emotion::imgurl)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Emotion::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Emotion.data,
      qt_meta_data_Emotion,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Emotion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Emotion.stringdata0))
...
// SIGNAL 0
void Emotion::imgurl(QString _t1)
{
